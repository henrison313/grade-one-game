import{a as e,r as t}from"./config-msfdsG27.js";import{A as n,B as r,C as i,D as a,E as o,F as s,G as c,H as l,J as u,K as d,L as f,M as p,N as m,O as h,P as g,R as _,S as v,T as y,U as b,V as x,W as S,Y as C,Z as w,_ as T,b as E,c as D,d as O,g as ee,h as te,j as ne,k,l as A,n as j,p as re,q as ie,s as ae,u as oe,v as se,w as ce,x as le,y as ue,z as M}from"./index-mua3UOFX.js";import"./services-C_Dthk5B.js";import{r as de}from"./character-variants.data-B-ngZo2l.js";import{a as fe,i as pe,n as me,o as he,r as ge,t as _e}from"./hidden-levels.data-Bu2jFcep.js";import{a as ve,i as ye,n as be,r as xe,t as Se}from"./weapon-configs.data-TetnjwBv.js";var N=w(C(),1),Ce=[{type:`choice`,question:`下面哪个图形是圆形？`,options:[{id:`a`,text:``,shape:`circle`,shapeColor:`blue`},{id:`b`,text:``,shape:`triangle`,shapeColor:`red`},{id:`c`,text:``,shape:`square`,shapeColor:`green`},{id:`d`,text:``,shape:`rectangle`,shapeColor:`yellow`}],correctAnswer:`a`,explanation:`圆形是圆圆的，像一个球或者轮子，没有尖尖的角！`,hint:`想想哪些东西是圆圆的？比如皮球、时钟...`},{type:`choice`,question:`找出图中的三角形物体！`,questionImage:M(`/assets/shapes/triangle1.webp`),options:[{id:`a`,text:`太阳伞 ☀️（伞面）`},{id:`b`,text:`皮球 🏀`},{id:`c`,text:`书本 📚`},{id:`d`,text:`窗户 🪟`}],correctAnswer:`a`,explanation:`太阳伞的伞面是三角形！三角形有三条边和三个角。`,hint:`三角形像一个小帐篷，有尖尖的角！`},{type:`choice`,question:`数一数，图中有几个正方形？
...
`,go={initial:{opacity:0,scale:.8,y:20},animate:{opacity:1,scale:1,y:0,transition:{type:`spring`,stiffness:200,damping:20}},exit:{opacity:0,scale:.9,y:-10,transition:{duration:.3}}},_o=({narrative:e,partName:t,enableSpeech:n=!0,speaker:r=`炫蓝闪电`})=>{let i=(0,N.useRef)(!1);return(0,N.useEffect)(()=>{if(!n||!e)return;A.stop();let t=setTimeout(()=>{i.current=!0,A.speak(e,r,()=>{i.current=!1})},300);return()=>{clearTimeout(t),A.stop(),i.current=!1}},[e,n,r]),(0,P.jsx)(x,{mode:`wait`,children:(0,P.jsxs)(co,{variants:go,initial:`initial`,animate:`animate`,exit:`exit`,children:[(0,P.jsx)(lo,{children:`✨`}),(0,P.jsx)(uo,{children:`☁️`}),(0,P.jsx)(fo,{children:(()=>{if(!t)return e;let n=RegExp(`"(${t})"`,`g`);return e.split(n).map((e,n)=>e===t?(0,P.jsxs)(po,{children:[`"`,e,`"`]},n):e)})()}),n&&(0,P.jsxs)(mo,{initial:{opacity:0},animate:{opacity:1},transition:{delay:.5},children:[(0,P.jsx)(ho,{children:`🎵`}),`正在朗读...`]})]},e)})},vo={pink:`#FFB5BA`,mint:`#7FCCB0`,sky:`#89CFF0`,yellow:`#FFE66D`,lavender:`#E6E6FA`,coral:`#FF7F7F`,peach:`#FFCBA4`,cream:`#FFF8E7`},yo=S`
  0%, 100% {
