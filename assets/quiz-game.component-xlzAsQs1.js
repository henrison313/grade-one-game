import{a as e,r as t}from"./config-msfdsG27.js";import{A as n,B as r,C as i,D as a,E as o,F as s,G as c,H as l,J as u,K as d,L as f,M as p,N as m,O as h,P as g,R as _,S as v,T as y,U as b,V as x,W as S,Y as C,Z as w,_ as T,b as E,c as D,d as O,g as ee,h as te,j as ne,k,l as A,n as j,p as re,q as ie,s as ae,u as oe,v as se,w as ce,x as le,y as ue,z as M}from"./index-D2uuPUim.js";import"./services-C_Dthk5B.js";import{r as de}from"./character-variants.data-jke_ZPKY.js";import{a as fe,i as pe,n as me,o as he,r as ge,t as _e}from"./hidden-levels.data-Bsqb5Jk_.js";import{a as ve,i as ye,n as be,r as xe,t as Se}from"./weapon-configs.data-at_vjP3K.js";var N=w(C(),1),Ce=[{type:`choice`,question:`下面哪个图形是圆形？`,options:[{id:`a`,text:``,shape:`circle`,shapeColor:`blue`},{id:`b`,text:``,shape:`triangle`,shapeColor:`red`},{id:`c`,text:``,shape:`square`,shapeColor:`green`},{id:`d`,text:``,shape:`rectangle`,shapeColor:`yellow`}],correctAnswer:`a`,explanation:`圆形是圆圆的，像一个球或者轮子，没有尖尖的角！`,hint:`想想哪些东西是圆圆的？比如皮球、时钟...`},{type:`choice`,question:`找出图中的三角形物体！`,questionImage:M(`/assets/shapes/triangle1.webp`),options:[{id:`a`,text:`太阳伞 ☀️（伞面）`},{id:`b`,text:`皮球 🏀`},{id:`c`,text:`书本 📚`},{id:`d`,text:`窗户 🪟`}],correctAnswer:`a`,explanation:`太阳伞的伞面是三角形！三角形有三条边和三个角。`,hint:`三角形像一个小帐篷，有尖尖的角！`},{type:`choice`,question:`数一数，图中有几个正方形？
...
//# sourceMappingURL=quiz-game.component-xlzAsQs1.js.map