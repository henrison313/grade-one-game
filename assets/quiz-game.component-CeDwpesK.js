...
`,Eo=()=>{let{levelId:e}=c(),[r]=d(),s=x(),{playBGM:l,stopBGM:f}=A(),g=r.get(`difficulty`)||u.EASY,y=r.get(`question`);(0,M.useEffect)(()=>(l(`battle`),()=>{f()}),[l,f]);let b=ee(e||`1-1`)||ge(e||``),S=fe[g],T=de[e||`1-1`]?.[g]||me[g],k=(0,M.useMemo)(()=>e===`1-1`&&Te[g]?Te[g]:e===`1-2`&&p[g]?p[g]:e===`1-3`&&E[g]?E[g]:e===`2-1`&&n[g]?n[g]:e===`2-2`&&re[g]?re[g]:e===`2-3`&&h[g]?h[g]:e===`2-4`&&a[g]?a[g]:e===`3-1`&&o[g]?o[g]:e===`3-2`&&v[g]?v[g]:e===`3-3`&&se[g]?se[g]:e===`3-4`&&i[g]?i[g]:e===`4-1`&&_[g]?_[g]:e===`4-2`&&ce[g]?ce[g]:e===`4-3`&&w[g]?w[g]:e===`5-1`&&le[g]?le[g]:e===`5-2`&&oe[g]?oe[g]:e===`6`&&C[g]?C[g]:e===`7-1`&&te[g]?te[g]:e===`7-2`&&ne[g]?ne[g]:e===`8`&&O[g]?O[g]:e===`9`&&ie[g]?ie[g]:(e===`h1`||e===`H1`)&&he[g]?he[g]:(e===`h2`||e===`H2`)&&pe[g]?pe[g]:b?.questions||[],[e,b,g]),ae=e=>e&&[`4-2`,`4-3`,`5-1`,`5-2`,`6`,`7-1`,`7-2`,`8`,`9`,`H1`,`H2`].includes(e)?`xuanlan-shandian-s`:`xuanlan-shandian`,Se=e=>e===`4-1`,Ce=ae(e),we=xe(Ce,g),Ee=be(Ce,g),De=ye(e||``,g),Oe=ve(e||``,g),ke=e===`1-1`,Ae=ke?we:De,je=ke?Ee:Oe,Me=_e(e||``,g),P=T?{...T,weapon:{...T.weapon,name:je,completeImage:Ae,parts:Me}}:void 0,Ne=(0,M.useMemo)(()=>{if(!y)return 0;let e=parseInt(y,10);if(isNaN(e)||e<1)return 0;let t=e-1;return t>=k.length?0:t},[y,k.length]),[F,Fe]=(0,M.useState)(g===`easy`?`quiz`:`guardianUpgrade`),[I,Ie]=(0,M.useState)(Ne),[Le,Re]=(0,M.useState)([]),[L,ze]=(0,M.useState)(0),[R,Be]=(0,M.useState)(!1),[Ve,He]=(0,M.useState)(!1),[z,B]=(0,M.useState)({selectedAnswer:null,placements:{},marks:[]}),[Ue,We]=(0,M.useState)([]),V=k[I],Ge=k.length,Ke=I===Ge-1,H=(0,M.useMemo)(()=>V?yo(V):null,[V]),U=Math.floor(Ge*t.starsPerQuestion*S.starMultiplier),qe=L>=Math.floor(U*S.starRequirement),Je=P?.weapon?.parts?Ue.length===P.weapon.parts.length:!1,W=(0,M.useCallback)((e,n=0)=>{if(!V)return;Be(!0);let r=!1,i=Math.floor((t.starsPerQuestion+n)*S.starMultiplier);switch(V.type){case`choice`:r=e===V.correctAnswer,B(t=>({...t,selectedAnswer:e}));break;case`multi_select`:{let t=V,n=e;r=Array.isArray(n)&&n.length===t.correctAnswers.length&&n.every(e=>t.correctAnswers.includes(e)),B(e=>({...e,selectedAnswer:n}));break}case`drag`:{let t=e;if(t.__digitPlacementCorrect){r=!0,B(e=>({...e,placements:{}}));break}let n=V;r=n.items.every(e=>{let r=Object.keys(t).find(n=>t[n].includes(e.id));if(!r)return!1;let i=n.targets.find(e=>e.id===r);return i?e.group&&i.group?e.group===i.group:i.accepts.includes(e.id):!1}),B(e=>({...e,placements:t}));break}case`circle`:B(t=>({...t,marks:e}));return;case`fill_blank`:{let t=V,n=e,i=Array.isArray(t.answer)?t.answer:[t.answer],a=n.split(`,`).map(e=>e.trim().toLowerCase()),o=(t.question.match(/\{\{___\}\}/g)||[]).length;r=o===1?i.some(e=>e.trim().toLowerCase()===a[0]):a.length===o&&a.every((e,t)=>(i[t]||i[0]).split(`,`).map(e=>e.trim().toLowerCase()).includes(e)),B(e=>({...e,selectedAnswer:n}));break}case`link`:{let t=V,n=e,i=t.pairs;if(n.length!==i.length){r=!1;break}r=n.every(e=>{let t=i.find(t=>t.id===e.leftId),n=i.find(t=>t.id===e.rightId);return!t||!n?!1:t.group&&n.group?t.group===n.group:e.leftId===e.rightId});break}case`maze`:case`shape_match`:case`tangram`:case`combo`:case`shape_compose`:r=!0,i=n;break;case`timed`:r=e?.isCorrect||!1,i=t.starsPerQuestion+(e?.timeRemaining||0);break}let a={questionId:`q${I+1}`,isCorrect:r,timeSpent:0,answer:e};if(Re(e=>[...e,a]),r){ze(e=>e+i);let e=P?.weapon?.parts?.[I];e&&We(t=>[...t,e.id])}setTimeout(()=>He(!0),500)},[V,I,S,P]),Ye=(0,M.useCallback)(e=>{if(!V)return;Be(!0),B(t=>({...t,marks:e}));let n=e.length>0,r=Math.floor(t.starsPerQuestion*S.starMultiplier),i={questionId:`q${I+1}`,isCorrect:n,timeSpent:0,answer:e};if(Re(e=>[...e,i]),n){ze(e=>e+r);let e=P?.weapon?.parts?.[I];e&&We(t=>[...t,e.id])}setTimeout(()=>He(!0),500)},[V,I,S,P]),Xe=(0,M.useCallback)(()=>{He(!1),Be(!1),B({selectedAnswer:null,placements:{},marks:[]}),Ke?qe?Fe(`weaponShowcase`):Ze():Ie(e=>e+1)},[Ke,qe,L,b,e]),Ze=(0,M.useCallback)(()=>{if(b){D.updateLevelProgress(b.id,{status:`completed`,stars:L},g),D.unlockNextLevel(b.id);let e=ue(b.guardian.id,g),t,n;if(e)t=e.variant,n=e.rarity;else switch(g){case u.MEDIUM:t=`flame`,n=`gold`;break;case u.HARD:t=`ultimate`,n=`rainbow`;break;default:t=`base`,n=`rare`}D.hasCollectedCard(b.guardian.id,t)||D.addCollectedCard(b.guardian.id,b.id,L,t,n,g)}s(`/level/${e}/complete?stars=${L}&difficulty=${g}&maxStars=${U}`)},[b,e,s,L,g,U]),Qe=()=>{s(`/levels`)},$e=()=>{if(!V||!H)return null;switch(H.type){case`choice`:return(0,N.jsx)(Pe,{question:H,selectedAnswer:z.selectedAnswer,isAnswered:R,onAnswer:e=>W(e)});case`drag`:return(0,N.jsx)(ft,{question:H,placements:z.placements,isAnswered:R,onAnswer:e=>W(e)});case`circle`:return(0,N.jsx)(Ct,{question:H,marks:z.marks,isAnswered:R,onAnswer:e=>Ye(e)});case`multi_select`:return(0,N.jsx)(Ft,{question:H,selectedAnswers:z.selectedAnswer,isAnswered:R,onAnswer:e=>W(e)});case`fill_blank`:return(0,N.jsx)(Zt,{question:H,selectedAnswer:z.selectedAnswer,isAnswered:R,onAnswer:e=>W(e)});case`link`:return(0,N.jsx)(Mn,{question:H,onAnswer:e=>W(e)});case`maze`:return(0,N.jsx)(Wn,{question:H,onComplete:e=>W(null,e)});case`shape_match`:return(0,N.jsx)(ir,{config:H,onComplete:e=>W(null,e)});case`tangram`:return(0,N.jsx)(kr,{question:H,onComplete:e=>W(null,e)});case`combo`:return(0,N.jsx)(Wr,{config:H,onComplete:e=>W(null,e)});case`timed`:return(0,N.jsx)(ri,{question:H,onAnswer:(e,t)=>{W({isCorrect:!0,timeRemaining:t},t)}});case`shape_compose`:return(0,N.jsx)(_n,{question:H,isAnswered:R,onAnswer:e=>W(e,t.starsPerQuestion)});default:return(0,N.jsxs)(`div`,{children:[`未知题目类型：`,H.type]})}};return b?(0,N.jsxs)(bo,{children:[(0,N.jsx)(xo,{$position:`top: 25%; left: -20px;`,children:`☁️`}),(0,N.jsx)(xo,{$position:`top: 60%; right: -25px; animation-delay: 2s;`,children:`☁️`}),F===`quiz`&&(0,N.jsxs)(N.Fragment,{children:[(0,N.jsxs)(So,{children:[(0,N.jsx)(_i,{currentQuestion:I,totalQuestions:Ge,starsEarned:L,levelName:b.name}),P?.weapon?.parts&&(0,N.jsx)(Pa,{parts:P.weapon.parts,currentIndex:I,collectedParts:Ue,difficulty:g,weaponImage:P.weapon.completeImage})]}),P?.narratives?.[I]&&(0,N.jsx)(po,{narrative:P.narratives[I].text,partName:P.weapon.parts?.[I]?.name},I),(0,N.jsxs)(Co,{children:[(0,N.jsxs)(wo,{initial:{opacity:0,y:30},animate:{opacity:1,y:0},exit:{opacity:0,y:-20},transition:{duration:.4,type:`spring`,stiffness:200},children:[P?.narratives?.[I]?.sceneBackground&&(0,N.jsx)(eo,{scene:P.narratives[I].sceneBackground,children:$e()}),!P?.narratives?.[I]?.sceneBackground&&$e()]},I),(0,N.jsx)(To,{onClick:Qe,whileHover:{scale:1.08},whileTap:{scale:.95},children:`🚪 退出`})]}),(0,N.jsx)(j,{children:Ve&&(0,N.jsx)(ki,{isCorrect:Le[Le.length-1]?.isCorrect||!1,explanation:V&&V.explanation||``,onNext:Xe,isLastQuestion:Ke,autoNext:Le[Le.length-1]?.isCorrect})})]}),F===`guardianUpgrade`&&b&&(0,N.jsx)(ea,{guardian:b.guardian,difficulty:g,onComplete:()=>Fe(`quiz`)}),F===`weaponShowcase`&&P?.weapon&&(0,N.jsx)(Vi,{weaponImage:P.weapon.completeImage||`/assets/weapons/easy-weapon.png`,weaponName:P.weapon.name||`超级武器`,difficulty:g,onComplete:()=>Fe(`battleScene`)}),F===`battleScene`&&b&&(0,N.jsx)(Sa,{hero:m.find(e=>e.id===Ce)||m[0],enemy:b.guardian,difficulty:g,weaponComplete:Je,weaponImage:we,enemyWeaponImage:De,isUpgrade:Se(e),isFusion:e===`H1`||e===`h1`,onComplete:()=>{Fe(`complete`),Ze()}})]}):(0,N.jsx)(bo,{children:(0,N.jsx)(wo,{children:`关卡不存在`})})};export{Eo as default};
//# sourceMappingURL=quiz-game.component-CeDwpesK.js.map