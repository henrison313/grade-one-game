...
export const levelH2MediumQuestions: Question[] = [
  ...
  },
  {
    ...
    options: [
      { id: 'a', text: '只考加法：5+3=？' },
      { id: 'b', text: '只考减法：10-5=？' },
      { id: 'c', text: '综合应用：小明有50元，买25元的书和12元的笔，还剩多少元？' },
  ...
  {
    type: 'fill_blank' as QuestionType.FILL_BLANK,
    question: '炫蓝雷霆王说："三合体终极考验！全单元融合！找规律：1、4、9、16、{{___}}（平方数列）。小明有50元，用这个数买书，还剩多少元？{{___}}"',
    answer: ['25', '25'],
...
export const levelH2HardQuestions: Question[] = [
  ...
  {
    type: 'fill_blank' as QuestionType.FILL_BLANK,
    question: '炫蓝雷霆王终极爆裂！"粉碎重装赤魂王的阴谋！炫蓝雷霆王与重轨巨神合力保护蓝星！终极综合考验：找规律2、5、10、17、26、37、{{___}}（每次加的数递增2）。这个终极能量是{{___}}！"',
    answer: ['50', '50'],
