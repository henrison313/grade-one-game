...
export const level2_4EasyWeaponParts: WeaponPart[] = [
  { id: 'fission-easy-core', name: '裂变核心', shapeType: 'circle', iconImage: getAssetPath('/assets/weapons/光能核心.png') },
  { id: 'fission-easy-shield', name: '炫光盾面', shapeType: 'rectangle', iconImage: getAssetPath('/assets/weapons/光能护盾.png') },
  { id: 'fission-easy-edge', name: '裂变边缘', shapeType: 'triangle', iconImage: getAssetPath('/assets/weapons/光能发射器.png') },
  { id: 'fission-easy-gem', name: '能量宝石', shapeType: 'circle', iconImage: getAssetPath('/assets/weapons/光能外壳.png') },
  { id: 'fission-easy-complete', name: '炫光裂变盾完成', shapeType: 'composite', iconImage: getAssetPath('/assets/weapons/easy-weapon.png') },
]
...
export const level2_4MediumWeaponParts: WeaponPart[] = [
  { id: 'fission-medium-blade', name: '裂变剑刃', shapeType: 'triangle', iconImage: getAssetPath('/assets/weapons/光能发射器.png') },
  { id: 'fission-medium-handle', name: '圣剑握柄', shapeType: 'rectangle', iconImage: getAssetPath('/assets/weapons/光能护盾.png') },
  { id: 'fission-medium-guard', name: '剑格护手', shapeType: 'rectangle', iconImage: getAssetPath('/assets/weapons/光能核心.png') },
  { id: 'fission-medium-complete', name: '裂变圣剑完成', shapeType: 'composite', iconImage: getAssetPath('/assets/weapons/medium-weapon.png') },
]
...
export const level2_4HardWeaponParts: WeaponPart[] = [
  { id: 'fission-hard-engine', name: '雷霆引擎', shapeType: 'circle', iconImage: getAssetPath('/assets/weapons/光能核心.png') },
  { id: 'fission-hard-body', name: '裂变机体', shapeType: 'rectangle', iconImage: getAssetPath('/assets/weapons/光能外壳.png') },
  { id: 'fission-hard-wing', name: '裂变双翼', shapeType: 'triangle', iconImage: getAssetPath('/assets/weapons/光能发射器.png') },
  { id: 'fission-hard-complete', name: '雷霆裂变机完成', shapeType: 'composite', iconImage: getAssetPath('/assets/weapons/hard-weapon.png') },
]
