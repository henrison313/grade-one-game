...
export const level52EasyWeaponParts: WeaponPart[] = [
  { id: 'easy-arm-core', name: '神力探测核心', shapeType: 'circle', iconImage: getAssetPath('/assets/weapons/weapon-part-1.webp') },
  { id: 'easy-arm-nav', name: '神力导航仪', shapeType: 'triangle', iconImage: getAssetPath('/assets/weapons/weapon-part-2.webp') },
  { id: 'easy-arm-head', name: '横扫千军头', shapeType: 'triangle', iconImage: getAssetPath('/assets/weapons/weapon-part-3.webp') },
  { id: 'easy-arm-pipe', name: '神力穿梭管', shapeType: 'square', iconImage: getAssetPath('/assets/weapons/weapon-part-4.webp') },
...
export const level52MediumWeaponParts: WeaponPart[] = [
  { id: 'med-arm-core', name: '神力探测核心', shapeType: 'circle', iconImage: getAssetPath('/assets/weapons/weapon-part-1.webp') },
  { id: 'med-arm-loc', name: '神力定位器', shapeType: 'triangle', iconImage: getAssetPath('/assets/weapons/weapon-part-2.webp') },
  { id: 'med-arm-armor', name: '神力装甲板', shapeType: 'square', iconImage: getAssetPath('/assets/weapons/weapon-part-3.webp') },
  { id: 'med-arm-meter', name: '神力计量管', shapeType: 'square', iconImage: getAssetPath('/assets/weapons/weapon-part-4.webp') },
...
export const level52HardWeaponParts: WeaponPart[] = [
  { id: 'hard-arm-partner', name: '伙伴神力核心', shapeType: 'circle', iconImage: getAssetPath('/assets/weapons/weapon-part-1.webp') },
  { id: 'hard-arm-fair', name: '神力公平仪', shapeType: 'triangle', iconImage: getAssetPath('/assets/weapons/weapon-part-2.webp') },
  { id: 'hard-arm-sys', name: '横扫千军系统', shapeType: 'square', iconImage: getAssetPath('/assets/weapons/weapon-part-3.webp') },
  { id: 'hard-arm-armor', name: '神力装甲管', shapeType: 'square', iconImage: getAssetPath('/assets/weapons/weapon-part-4.webp') },
