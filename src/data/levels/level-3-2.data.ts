...
export const level3_2EasyWeaponParts: WeaponPart[] = [
  ...
  { id: 'ship-easy-complete', name: '炫光炮舰完成', shapeType: 'composite', iconImage: getAssetPath('/assets/weapons/easy-xuanlan-shandian-light.png') },
]
...
export const level3_2MediumWeaponParts: WeaponPart[] = [
  ...
  { id: 'ship-medium-complete', name: '炮舰炮完成', shapeType: 'composite', iconImage: getAssetPath('/assets/weapons/medium-xuanlan-shandian-bolt.png') },
]
...
export const level3_2HardWeaponParts: WeaponPart[] = [
  ...
  { id: 'ship-hard-complete', name: '雷霆炮舰完成', shapeType: 'composite', iconImage: getAssetPath('/assets/weapons/hard-xuanlan-shandian-thunder.png') },
]
