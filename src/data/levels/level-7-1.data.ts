...
export const level71EasyWeaponParts: WeaponPart[] = [
  { id: 'easy-drill-core', name: '爆旋探测核心', shapeType: 'circle', iconImage: getAssetPath('/assets/weapons/weapon-part-1.webp') },
  { id: 'easy-drill-nav', name: '爆旋导航仪', shapeType: 'triangle', iconImage: getAssetPath('/assets/weapons/weapon-part-3.webp') },
  { id: 'easy-drill-head', name: '爆旋轰钻头', shapeType: 'triangle', iconImage: getAssetPath('/assets/weapons/weapon-part-2.webp') },
  { id: 'easy-drill-pipe', name: '爆旋穿梭管', shapeType: 'square', iconImage: getAssetPath('/assets/weapons/weapon-part-4.webp') },
  { id: 'easy-drill-complete', name: '爆旋轰钻完成', shapeType: 'composite', iconImage: getAssetPath('/assets/weapons/easy-xuanlan-shandian-light.webp') },
]

export const level71MediumWeaponParts: WeaponPart[] = [
  { id: 'med-drill-core', name: '爆旋探测核心', shapeType: 'circle', iconImage: getAssetPath('/assets/weapons/weapon-part-1.webp') },
  { id: 'med-drill-loc', name: '爆旋定位器', shapeType: 'triangle', iconImage: getAssetPath('/assets/weapons/weapon-part-3.webp') },
  { id: 'med-drill-armor', name: '爆旋装甲板', shapeType: 'square', iconImage: getAssetPath('/assets/weapons/weapon-part-2.webp') },
  { id: 'med-drill-meter', name: '爆旋计量管', shapeType: 'square', iconImage: getAssetPath('/assets/weapons/weapon-part-4.webp') },
  { id: 'med-drill-cannon', name: '爆旋洛克战炮完成', shapeType: 'composite', iconImage: getAssetPath('/assets/weapons/medium-xuanlan-shandian-bolt.webp') },
]

export const level71HardWeaponParts: WeaponPart[] = [
  { id: 'hard-drill-partner', name: '伙伴爆旋核心', shapeType: 'circle', iconImage: getAssetPath('/assets/weapons/weapon-part-1.webp') },
  { id: 'hard-drill-fair', name: '爆旋公平仪', shapeType: 'triangle', iconImage: getAssetPath('/assets/weapons/weapon-part-3.webp') },
  { id: 'hard-drill-sys', name: '爆旋轰钻系统', shapeType: 'square', iconImage: getAssetPath('/assets/weapons/weapon-part-2.webp') },
  { id: 'hard-drill-armor', name: '爆旋装甲管', shapeType: 'square', iconImage: getAssetPath('/assets/weapons/weapon-part-4.webp') },
  { id: 'hard-drill-ult', name: '爆旋洛克终极炮完成', shapeType: 'composite', iconImage: getAssetPath('/assets/weapons/hard-xuanlan-shandian-thunder.webp') },
]
