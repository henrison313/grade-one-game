...
export const level72EasyWeaponParts: WeaponPart[] = [
  { id: 'easy-sea-core', name: '海王探测核心', shapeType: 'circle', iconImage: getAssetPath('/assets/weapons/光能核心.png') },
...
export const level72MediumWeaponParts: WeaponPart[] = [
  { id: 'med-sea-core', name: '海王探测核心', shapeType: 'circle', iconImage: getAssetPath('/assets/weapons/光能核心.png') },
...
export const level72HardWeaponParts: WeaponPart[] = [
  { id: 'hard-sea-partner', name: '伙伴海王核心', shapeType: 'circle', iconImage: getAssetPath('/assets/weapons/光能核心.png') },
