...
export const level3_3EasyWeaponParts: WeaponPart[] = [
  { id: 'gravity-easy-core', name: '重力核心', shapeType: 'circle', iconImage: getAssetPath('/assets/weapons/weapon-part-1.webp') },
  { id: 'gravity-easy-shell', name: '炫光外壳', shapeType: 'rectangle', iconImage: getAssetPath('/assets/weapons/weapon-part-4.webp') },
  { id: 'gravity-easy-cannon', name: '炫光炮管', shapeType: 'triangle', iconImage: getAssetPath('/assets/weapons/weapon-part-2.webp') },
  { id: 'gravity-easy-gauge', name: '重力仪表', shapeType: 'square', iconImage: getAssetPath('/assets/weapons/weapon-part-3.webp') },
...
export const level3_3MediumWeaponParts: WeaponPart[] = [
  { id: 'gravity-medium-core', name: '重力炮核心', shapeType: 'circle', iconImage: getAssetPath('/assets/weapons/weapon-part-1.webp') },
  { id: 'gravity-medium-shell', name: '重力炮身', shapeType: 'rectangle', iconImage: getAssetPath('/assets/weapons/weapon-part-4.webp') },
  { id: 'gravity-medium-cannon', name: '重型炮管', shapeType: 'triangle', iconImage: getAssetPath('/assets/weapons/weapon-part-2.webp') },
...
export const level3_3HardWeaponParts: WeaponPart[] = [
  { id: 'gravity-hard-ring', name: '雷霆能量环', shapeType: 'circle', iconImage: getAssetPath('/assets/weapons/weapon-part-1.webp') },
  { id: 'gravity-hard-shell', name: '雷霆炮身', shapeType: 'rectangle', iconImage: getAssetPath('/assets/weapons/weapon-part-4.webp') },
  { id: 'gravity-hard-cannon', name: '雷霆炮管', shapeType: 'triangle', iconImage: getAssetPath('/assets/weapons/weapon-part-2.webp') },
