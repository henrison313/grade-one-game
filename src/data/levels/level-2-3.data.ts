...
export const level2_3EasyWeaponParts: WeaponPart[] = [
  { id: 'jet-easy-core', name: '喷射核心', shapeType: 'circle', iconImage: getAssetPath('/assets/weapons/weapon-part-1.webp') },
  { id: 'jet-easy-arrow', name: '炫光箭矢', shapeType: 'triangle', iconImage: getAssetPath('/assets/weapons/weapon-part-2.webp') },
  { id: 'jet-easy-bow', name: '喷射弓架', shapeType: 'rectangle', iconImage: getAssetPath('/assets/weapons/weapon-part-3.webp') },
  { id: 'jet-easy-wing', name: '雄鹰羽翼', shapeType: 'triangle', iconImage: getAssetPath('/assets/weapons/weapon-part-4.webp') },
...
export const level2_3MediumWeaponParts: WeaponPart[] = [
  { id: 'jet-medium-core', name: '飞鸟核心', shapeType: 'circle', iconImage: getAssetPath('/assets/weapons/weapon-part-1.webp') },
  { id: 'jet-medium-barrel', name: '突击炮管', shapeType: 'rectangle', iconImage: getAssetPath('/assets/weapons/weapon-part-2.webp') },
  { id: 'jet-medium-wing', name: '展翅羽翼', shapeType: 'triangle', iconImage: getAssetPath('/assets/weapons/weapon-part-3.webp') },
...
export const level2_3HardWeaponParts: WeaponPart[] = [
  { id: 'jet-hard-ring', name: '雷霆能量环', shapeType: 'circle', iconImage: getAssetPath('/assets/weapons/weapon-part-1.webp') },
  { id: 'jet-hard-prism', name: '高空聚焦棱', shapeType: 'triangle', iconImage: getAssetPath('/assets/weapons/weapon-part-2.webp') },
  { id: 'jet-hard-barrel', name: '雷霆喷射管', shapeType: 'rectangle', iconImage: getAssetPath('/assets/weapons/weapon-part-4.webp') },
