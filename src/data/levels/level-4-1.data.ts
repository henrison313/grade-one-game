...
export const level41EasyWeaponParts: WeaponPart[] = [
  { id: 'easy-blue-s-core', name: '炫蓝探测核心', shapeType: 'circle', iconImage: getAssetPath('/assets/weapons/weapon-part-1.webp') },
  { id: 'easy-blue-s-navigator', name: '炫蓝导航仪', shapeType: 'triangle', iconImage: getAssetPath('/assets/weapons/weapon-part-2.webp') },
  { id: 'easy-blue-s-punch-head', name: '炫蓝重拳头', shapeType: 'triangle', iconImage: getAssetPath('/assets/weapons/weapon-part-3.webp') },
  { id: 'easy-blue-s-armor-pipe', name: '炫蓝战甲管', shapeType: 'square', iconImage: getAssetPath('/assets/weapons/weapon-part-4.webp') },
...
export const level41MediumWeaponParts: WeaponPart[] = [
  { id: 'medium-meteor-core', name: '流星探测核心', shapeType: 'circle', iconImage: getAssetPath('/assets/weapons/weapon-part-1.webp') },
  { id: 'medium-meteor-locator', name: '流星定位器', shapeType: 'triangle', iconImage: getAssetPath('/assets/weapons/weapon-part-2.webp') },
  { id: 'medium-meteor-armor-plate', name: '流星装甲板', shapeType: 'square', iconImage: getAssetPath('/assets/weapons/weapon-part-3.webp') },
...
export const level41HardWeaponParts: WeaponPart[] = [
  { id: 'hard-starburst-command-core', name: '星爆指挥核心', shapeType: 'circle', iconImage: getAssetPath('/assets/weapons/weapon-part-1.webp') },
  { id: 'hard-courage-navigator', name: '勇气导航仪', shapeType: 'triangle', iconImage: getAssetPath('/assets/weapons/weapon-part-2.webp') },
  { id: 'hard-starburst-punch-system', name: '星爆重拳系统', shapeType: 'square', iconImage: getAssetPath('/assets/weapons/weapon-part-4.webp') },
