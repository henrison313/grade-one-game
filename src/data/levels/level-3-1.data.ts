...
export const level3_1Questions: Question[] = [
  ...
  // 题目 3：拖拽题
  {
    ...
    targets: [
      { id: '48', name: '48', accepts: ['1'], position: { x: 20, y: 50 }, size: { width: 90, height: 60 } },
      { id: '62', name: '62', accepts: ['2'], position: { x: 130, y: 50 }, size: { width: 90, height: 60 } },
      { id: '90', name: '90', accepts: ['3'], position: { x: 240, y: 50 }, size: { width: 90, height: 60 } },
      { id: '55', name: '55', accepts: ['4'], position: { x: 350, y: 50 }, size: { width: 90, height: 60 } },
    ],
