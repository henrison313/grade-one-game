...
export const level3_1EasyWeaponParts: WeaponPart[] = [
  { id: 'axe-easy-core', name: '战斧核心', shapeType: 'circle', iconImage: getAssetPath('/assets/weapons/weapon-part-1.webp') },
  { id: 'axe-easy-blade', name: '炫光斧刃', shapeType: 'triangle', iconImage: getAssetPath('/assets/weapons/weapon-part-2.webp') },
  { id: 'axe-easy-handle', name: '战斧握柄', shapeType: 'rectangle', iconImage: getAssetPath('/assets/weapons/weapon-part-3.webp') },
  { id: 'axe-easy-guard', name: '斧柄护手', shapeType: 'square', iconImage: getAssetPath('/assets/weapons/weapon-part-4.webp') },
  { id: 'axe-easy-complete', name: '炫光战斧完成', shapeType: 'composite', iconImage: getAssetPath('/assets/weapons/easy-xuanlan-shandian-light.webp') },
]
...
export const level3_1MediumWeaponParts: WeaponPart[] = [
  { id: 'axe-medium-core', name: '战斧炮核心', shapeType: 'circle', iconImage: getAssetPath('/assets/weapons/weapon-part-1.webp') },
  { id: 'axe-medium-blade', name: '战斧炮刃', shapeType: 'triangle', iconImage: getAssetPath('/assets/weapons/weapon-part-2.webp') },
  { id: 'axe-medium-barrel', name: '炮管外壳', shapeType: 'rectangle', iconImage: getAssetPath('/assets/weapons/weapon-part-4.webp') },
  { id: 'axe-medium-complete', name: '战斧炮完成', shapeType: 'composite', iconImage: getAssetPath('/assets/weapons/medium-xuanlan-shandian-bolt.webp') },
]
...
export const level3_1HardWeaponParts: WeaponPart[] = [
  { id: 'axe-hard-ring', name: '雷霆能量环', shapeType: 'circle', iconImage: getAssetPath('/assets/weapons/weapon-part-1.webp') },
  { id: 'axe-hard-blade', name: '雷霆斧刃', shapeType: 'triangle', iconImage: getAssetPath('/assets/weapons/weapon-part-2.webp') },
  { id: 'axe-hard-barrel', name: '雷霆炮身', shapeType: 'rectangle', iconImage: getAssetPath('/assets/weapons/weapon-part-4.webp') },
  { id: 'axe-hard-complete', name: '雷霆战斧完成', shapeType: 'composite', iconImage: getAssetPath('/assets/weapons/hard-xuanlan-shandian-thunder.webp') },
]
