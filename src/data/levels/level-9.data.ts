...
export const level9EasyWeaponParts: WeaponPart[] = [
  { id: 'easy-flame-core', name: '赤魂探测核心', shapeType: 'circle', iconImage: getAssetPath('/assets/weapons/weapon-part-1.webp') },
  { id: 'easy-flame-nav', name: '赤魂导航仪', shapeType: 'triangle', iconImage: getAssetPath('/assets/weapons/weapon-part-2.webp') },
  { id: 'easy-flame-head', name: '赤魂灭世头', shapeType: 'triangle', iconImage: getAssetPath('/assets/weapons/weapon-part-3.webp') },
  { id: 'easy-flame-pipe', name: '赤魂穿梭管', shapeType: 'square', iconImage: getAssetPath('/assets/weapons/weapon-part-4.webp') },
  { id: 'easy-flame-complete', name: '赤魂灭世完成', shapeType: 'composite', iconImage: getAssetPath('/assets/weapons/easy-xuanlan-shandian-light.webp') },
]

export const level9MediumWeaponParts: WeaponPart[] = [
  { id: 'med-flame-core', name: '赤魂探测核心', shapeType: 'circle', iconImage: getAssetPath('/assets/weapons/weapon-part-1.webp') },
  { id: 'med-flame-loc', name: '赤魂定位器', shapeType: 'triangle', iconImage: getAssetPath('/assets/weapons/weapon-part-2.webp') },
  { id: 'med-flame-armor', name: '赤魂装甲板', shapeType: 'square', iconImage: getAssetPath('/assets/weapons/weapon-part-3.webp') },
  { id: 'med-flame-meter', name: '赤魂计量管', shapeType: 'square', iconImage: getAssetPath('/assets/weapons/weapon-part-4.webp') },
  { id: 'med-flame-cannon', name: '重装赤魂王战炮完成', shapeType: 'composite', iconImage: getAssetPath('/assets/weapons/medium-xuanlan-shandian-bolt.webp') },
]

export const level9HardWeaponParts: WeaponPart[] = [
  { id: 'hard-flame-partner', name: '伙伴赤魂核心', shapeType: 'circle', iconImage: getAssetPath('/assets/weapons/weapon-part-1.webp') },
  { id: 'hard-flame-fair', name: '赤魂公平仪', shapeType: 'triangle', iconImage: getAssetPath('/assets/weapons/weapon-part-2.webp') },
  { id: 'hard-flame-sys', name: '赤魂灭世系统', shapeType: 'square', iconImage: getAssetPath('/assets/weapons/weapon-part-3.webp') },
  { id: 'hard-flame-armor', name: '赤魂装甲管', shapeType: 'square', iconImage: getAssetPath('/assets/weapons/weapon-part-4.webp') },
  { id: 'hard-flame-ult', name: '重装赤魂王终极炮完成', shapeType: 'composite', iconImage: getAssetPath('/assets/weapons/hard-xuanlan-shandian-thunder.webp') },
]
