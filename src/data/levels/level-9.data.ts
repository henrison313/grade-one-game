...
export const level9EasyWeaponParts: WeaponPart[] = [
  { id: 'easy-flame-core', name: '赤魂探测核心', shapeType: 'circle', iconImage: getAssetPath('/assets/weapons/光能核心.webp') },
  { id: 'easy-flame-nav', name: '赤魂导航仪', shapeType: 'triangle', iconImage: getAssetPath('/assets/weapons/光能发射器.webp') },
  { id: 'easy-flame-head', name: '赤魂灭世头', shapeType: 'triangle', iconImage: getAssetPath('/assets/weapons/光能护盾.webp') },
  { id: 'easy-flame-pipe', name: '赤魂穿梭管', shapeType: 'square', iconImage: getAssetPath('/assets/weapons/光能外壳.webp') },
...
export const level9MediumWeaponParts: WeaponPart[] = [
  { id: 'med-flame-core', name: '赤魂探测核心', shapeType: 'circle', iconImage: getAssetPath('/assets/weapons/光能核心.webp') },
  { id: 'med-flame-loc', name: '赤魂定位器', shapeType: 'triangle', iconImage: getAssetPath('/assets/weapons/光能发射器.webp') },
  { id: 'med-flame-armor', name: '赤魂装甲板', shapeType: 'square', iconImage: getAssetPath('/assets/weapons/光能护盾.webp') },
  { id: 'med-flame-meter', name: '赤魂计量管', shapeType: 'square', iconImage: getAssetPath('/assets/weapons/光能外壳.webp') },
...
export const level9HardWeaponParts: WeaponPart[] = [
  { id: 'hard-flame-partner', name: '伙伴赤魂核心', shapeType: 'circle', iconImage: getAssetPath('/assets/weapons/光能核心.webp') },
  { id: 'hard-flame-fair', name: '赤魂公平仪', shapeType: 'triangle', iconImage: getAssetPath('/assets/weapons/光能发射器.webp') },
  { id: 'hard-flame-sys', name: '赤魂灭世系统', shapeType: 'square', iconImage: getAssetPath('/assets/weapons/光能护盾.webp') },
  { id: 'hard-flame-armor', name: '赤魂装甲管', shapeType: 'square', iconImage: getAssetPath('/assets/weapons/光能外壳.webp') },
