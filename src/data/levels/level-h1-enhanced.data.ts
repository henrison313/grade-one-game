...
export const levelH1EasyWeaponParts: WeaponPart[] = [
  { id: 'easy-blue-core', name: '炫蓝探测核心', shapeType: 'circle', iconImage: '/assets/weapons/光能核心.png' },
  { id: 'easy-blue-nav', name: '炫蓝导航仪', shapeType: 'triangle', iconImage: '/assets/weapons/光能发射器.png' },
  { id: 'easy-blue-head', name: '炫蓝电光头', shapeType: 'triangle', iconImage: '/assets/weapons/光能护盾.png' },
  { id: 'easy-blue-pipe', name: '炫蓝穿梭管', shapeType: 'square', iconImage: '/assets/weapons/光能外壳.png' },
  { id: 'easy-blue-complete', name: '炫蓝电光炮完成', shapeType: 'composite', iconImage: '/assets/weapons/easy-weapon.png' },
]

export const levelH1MediumWeaponParts: WeaponPart[] = [
  { id: 'med-blue-core', name: '炫蓝探测核心（升级）', shapeType: 'circle', iconImage: '/assets/weapons/光能核心.png' },
  { id: 'med-blue-loc', name: '炫蓝定位器', shapeType: 'triangle', iconImage: '/assets/weapons/光能发射器.png' },
  { id: 'med-blue-armor', name: '炫蓝装甲板', shapeType: 'square', iconImage: '/assets/weapons/光能护盾.png' },
  { id: 'med-blue-meter', name: '炫蓝计量管', shapeType: 'square', iconImage: '/assets/weapons/光能外壳.png' },
  { id: 'med-blue-cannon', name: '炫蓝电光王战炮完成', shapeType: 'composite', iconImage: '/assets/weapons/medium-weapon.png' },
]

export const levelH1HardWeaponParts: WeaponPart[] = [
  { id: 'hard-ult-partner', name: '伙伴终极核心', shapeType: 'circle', iconImage: '/assets/weapons/光能核心.png' },
  { id: 'hard-ult-fair', name: '炫蓝公平仪', shapeType: 'triangle', iconImage: '/assets/weapons/光能发射器.png' },
  { id: 'hard-ult-sys', name: '终极爆裂系统', shapeType: 'square', iconImage: '/assets/weapons/光能护盾.png' },
  { id: 'hard-ult-armor', name: '炫蓝装甲管', shapeType: 'square', iconImage: '/assets/weapons/光能外壳.png' },
  { id: 'hard-ult-ult', name: '超炫电光王终极炮完成', shapeType: 'composite', iconImage: '/assets/weapons/hard-weapon.png' },
]
