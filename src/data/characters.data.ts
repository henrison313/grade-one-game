...
export const characters: Character[] = [
  ...
  // 010: 重力金刚 - 关卡 3-3 守护者
  {
    ...
    vehicleImage: '/图片素材/重力金刚.png',
    robotImage: '/图片素材/重力金刚.png',
    stats: {
      height: '4.8 米',
      weight: '5.5 吨',
      speed: '100km/h',
  ...
  // 011: 玄铁战神 - 关卡 3-4 守护者
  {
    ...
    vehicleImage: '/图片素材/玄铁战神.png',
    robotImage: '/图片素材/玄铁战神.png',
    stats: {
      height: '4.6 米',
      weight: '5.8 吨',
      speed: '130km/h',
  ...
  // 012: 炫蓝闪电 S - 关卡 4-1 守护者
  {
    ...
    vehicleImage: '/图片素材/炫蓝闪电 S.png',
    robotImage: '/图片素材/炫蓝闪电 S.png',
    stats: {
      height: '3.9 米',
      weight: '2.9 吨',
      speed: '450km/h',
  ...
  // 013: 焰龙战神 - 关卡 4-2 守护者
  {
    ...
    vehicleImage: '/图片素材/焰龙战神 1.png',
    robotImage: '/图片素材/焰龙战神 2.png',
    stats: {
      height: '4.5 米',
      weight: '3.8 吨',
      speed: '250km/h',
  ...
  // 014: 霹雳火影 - 关卡 5-1 守护者
  {
    ...
    vehicleImage: '/图片素材/霹雳火影.jpg',
    robotImage: '/图片素材/霹雳火影.jpg',
    stats: {
      height: '3.7 米',
      weight: '2.6 吨',
      speed: '320km/h',
  ...
  // 015: 猎空悍将 - 关卡 5-2 守护者
  {
    ...
    vehicleImage: '/图片素材/裂空悍将.png',
    robotImage: '/图片素材/裂空悍将.png',
    stats: {
      height: '4.0 米',
      weight: '3.0 吨',
      speed: '400km/h',
  ...
  // 016: 钢臂力士 - 关卡 6 BOSS
  {
    ...
    vehicleImage: '/图片素材/钢臂力士.png',
    robotImage: '/图片素材/钢臂力士.png',
    stats: {
      height: '5.2 米',
      weight: '6.5 吨',
      speed: '90km/h',
  ...
  // 017: 星际游侠 - 隐藏角色
  {
    ...
    vehicleImage: '/图片素材/星际游侠 1.png',
    robotImage: '/图片素材/星际游侠 2.png',
    stats: {
      height: '4.1 米',
      weight: '3.2 吨',
      speed: '500km/h',
  ...
  // 018: 爆旋洛克 - 隐藏角色
  {
    ...
    vehicleImage: '/图片素材/爆旋洛克.png',
    robotImage: '/图片素材/爆旋洛克.png',
    stats: {
      height: '3.8 米',
      weight: '3.0 吨',
      speed: '280km/h',
  ...
  // 019: 深海霸王 - 隐藏角色
  {
    ...
    vehicleImage: '/图片素材/深海霸王 1.png',
    robotImage: '/图片素材/深海霸王 2.png',
    stats: {
      height: '5.5 米',
      weight: '7.0 吨',
      speed: '180km/h',
  ...
  // 020: 银翼骑士 - 隐藏角色
  {
    ...
    vehicleImage: '/图片素材/银翼骑士.png',
    robotImage: '/图片素材/银翼骑士.png',
    stats: {
      height: '4.3 米',
      weight: '3.6 吨',
      speed: '260km/h',
