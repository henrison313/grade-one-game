...
const level1_1Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '炫蓝闪电',
    speakerImage: getAssetPath('/assets/character/xuanlan-shandian.png'),
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '巨力风暴',
    speakerImage: getAssetPath('/assets/character/juli-fengbao.png'),
...
const level1_2Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '急救卫士',
    speakerImage: getAssetPath('/assets/character/jiushi-weishi.png'),
...
const level2_1Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '暗影特工',
    speakerImage: getAssetPath('/assets/character/anying-tegong.png'),
...
const level2_2Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '铁臂爵士',
    speakerImage: getAssetPath('/assets/character/tiebi-jueshi.png'),
...
const level2_3Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '喷射加仑',
    speakerImage: getAssetPath('/assets/character/penshi-jialun.png'),
...
const level2_4Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '裂变骑士',
    speakerImage: getAssetPath('/assets/character/liebian-qishi.png'),
...
const level3_1Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '暴烈重卡',
    speakerImage: getAssetPath('/assets/character/baolie-zhongka.png'),
...
const level3_2Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '深海天锚',
    speakerImage: getAssetPath('/assets/character/shenhai-tianmao.png'),
...
const level3_3Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '重力金刚',
    speakerImage: getAssetPath('/assets/character/zhongli-jingang.png'),
...
const level3_4Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '超炫电光王',
    speakerImage: getAssetPath('/assets/character/chaoxuan-dianguangwang.png'),
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '玄铁战神',
    speakerImage: getAssetPath('/assets/character/xuantie-zhanshen.png'),
...
const level4_1Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '炫蓝闪电S',
    speakerImage: getAssetPath('/assets/character/xuanlan-shandian-s.png'),
...
const level4_2Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '焰龙战神',
    speakerImage: getAssetPath('/assets/character/yanlong-zhanshen.png'),
...
const level4_3Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '霹雳火影',
    speakerImage: getAssetPath('/assets/character/pili-huoying.png'),
...
const level5_1Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '猎空悍将',
    speakerImage: getAssetPath('/assets/character/liekong-hanjiang.png'),
...
const level5_2Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '钢臂力士',
    speakerImage: getAssetPath('/assets/character/gangbi-lishi.png'),
...
const level6Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '星际游侠',
    speakerImage: getAssetPath('/assets/character/xingji-youxia-1.png'),
...
const level7_1Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '爆旋洛克',
    speakerImage: getAssetPath('/assets/character/baoxuan-luoke.png'),
...
const level7_2Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '深海霸王',
    speakerImage: getAssetPath('/assets/character/shenhai-bawang.png'),
...
const level8Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '银翼骑士',
    speakerImage: getAssetPath('/assets/character/yinyi-qishi.png'),
...
const level9Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '炫蓝雷霆王',
    speakerImage: getAssetPath('/assets/character/xuanlan-leitingwang.png'),
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '重装赤魂王',
    speakerImage: getAssetPath('/assets/character/zhongzhuang-chihunwang.png'),
...
export const levels: Level[] = [
  // === 第一单元：图形与几何 ===
  {
    ...
    thumbnail: getAssetPath('/assets/character/juli-fengbao.png'),
    status: 'available',
    guardian: getCharacterById('juli-fengbao') || characters[0],
    mentor: {
      id: 'xuanlan-shandian',
      name: '炫蓝闪电',
      image: getAssetPath('/assets/character/xuanlan-shandian.png'),
      greeting: '欢迎来到炫卡世界！',
  ...
  },
  {
    ...
    thumbnail: getAssetPath('/assets/character/jiushi-weishi.png'),
    status: 'locked',
  ...
  },
  {
    ...
    thumbnail: getAssetPath('/assets/character/liehuo-xiuluo.png'),
    status: 'locked',
  ...
  // === 第二单元：20 以内退位减法 ===
  {
    ...
    thumbnail: getAssetPath('/assets/character/anying-tegong.png'),
    status: 'locked',
  ...
  },
  {
    ...
    thumbnail: getAssetPath('/assets/character/tiebi-jueshi.png'),
    status: 'locked',
  ...
  },
  {
    ...
    thumbnail: getAssetPath('/assets/character/penshi-jialun.png'),
    status: 'locked',
  ...
  },
  {
    ...
    thumbnail: getAssetPath('/assets/character/liebian-qishi.png'),
    status: 'locked',
  ...
  // === 第三单元：100 以内数的认识 ===
  {
    ...
    thumbnail: getAssetPath('/assets/character/baolie-zhongka.png'),
    status: 'locked',
  ...
  },
  {
    ...
    thumbnail: getAssetPath('/assets/character/shenhai-tianmao.png'),
    status: 'locked',
  ...
  },
  {
    ...
    thumbnail: getAssetPath('/assets/character/zhongli-jingang.png'),
    status: 'locked',
  ...
  },
  {
    ...
    thumbnail: getAssetPath('/assets/character/xuantie-zhanshen.png'),
    status: 'locked',
  ...
  // === 第四单元：100 以内口算加减法 ===
  {
    ...
    thumbnail: getAssetPath('/assets/character/xuanlan-shandian.png'),
    status: 'locked',
  ...
  },
  {
    ...
    thumbnail: getAssetPath('/assets/character/yanlong-zhanshen-1.png'),
    status: 'locked',
  ...
  },
  {
    ...
    thumbnail: getAssetPath('/assets/character/pili-huoying.png'),
    status: 'locked',
  ...
  // === 第五单元：100 以内笔算加减法 ===
  {
    ...
    thumbnail: getAssetPath('/assets/character/liekong-hanjiang.png'),
    status: 'locked',
  ...
  },
  {
    ...
    thumbnail: getAssetPath('/assets/character/gangbi-lishi.png'),
    status: 'locked',
  ...
  // === 第六单元：BOSS 关 ===
  {
    ...
    thumbnail: getAssetPath('/assets/character/xingji-youxia-1.png'),
    status: 'locked',
  ...
  // === 第七单元：欢乐购物街 ===
  {
    ...
    thumbnail: getAssetPath('/assets/character/baoxuan-luoke.png'),
    status: 'locked',
  ...
  },
  {
    ...
    thumbnail: getAssetPath('/assets/character/shenhai-bawang.png'),
    status: 'locked',
  ...
  // === 第八单元：找规律 ===
  {
    ...
    thumbnail: getAssetPath('/assets/character/yinyi-qishi.png'),
    status: 'locked',
  ...
  // === 第九单元：期末综合 ===
  {
    ...
    thumbnail: getAssetPath('/assets/character/zhongzhuang-chihunwang.png'),
    status: 'locked',
