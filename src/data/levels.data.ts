...
const level1_1Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '炫蓝闪电',
    speakerImage: getAssetPath('/assets/character/xuanlan-shandian.webp'),
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '巨力风暴',
    speakerImage: getAssetPath('/assets/character/juli-fengbao.webp'),
...
const level1_2Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '急救卫士',
    speakerImage: getAssetPath('/assets/character/jiushi-weishi.webp'),
...
const level2_1Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '暗影特工',
    speakerImage: getAssetPath('/assets/character/anying-tegong.webp'),
...
const level2_2Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '铁臂爵士',
    speakerImage: getAssetPath('/assets/character/tiebi-jueshi.webp'),
...
const level2_3Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '喷射加仑',
    speakerImage: getAssetPath('/assets/character/penshi-jialun.webp'),
...
const level2_4Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '裂变骑士',
    speakerImage: getAssetPath('/assets/character/liebian-qishi.webp'),
...
const level3_1Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '暴烈重卡',
    speakerImage: getAssetPath('/assets/character/baolie-zhongka.webp'),
...
const level3_2Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '深海天锚',
    speakerImage: getAssetPath('/assets/character/shenhai-tianmao.webp'),
...
const level3_3Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '重力金刚',
    speakerImage: getAssetPath('/assets/character/zhongli-jingang.webp'),
...
const level3_4Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '超炫电光王',
    speakerImage: getAssetPath('/assets/character/chaoxuan-dianguangwang.webp'),
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '玄铁战神',
    speakerImage: getAssetPath('/assets/character/xuantie-zhanshen.webp'),
...
const level4_1Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '炫蓝闪电S',
    speakerImage: getAssetPath('/assets/character/xuanlan-shandian-s.webp'),
...
const level4_2Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '焰龙战神',
    speakerImage: getAssetPath('/assets/character/yanlong-zhanshen.webp'),
...
const level4_3Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '霹雳火影',
    speakerImage: getAssetPath('/assets/character/pili-huoying.webp'),
...
const level5_1Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '猎空悍将',
    speakerImage: getAssetPath('/assets/character/liekong-hanjiang.webp'),
...
const level5_2Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '钢臂力士',
    speakerImage: getAssetPath('/assets/character/gangbi-lishi.webp'),
...
const level6Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '星际游侠',
    speakerImage: getAssetPath('/assets/character/xingji-youxia-1.webp'),
...
const level7_1Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '爆旋洛克',
    speakerImage: getAssetPath('/assets/character/baoxuan-luoke.webp'),
...
const level7_2Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '深海霸王',
    speakerImage: getAssetPath('/assets/character/shenhai-bawang.webp'),
...
const level8Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '银翼骑士',
    speakerImage: getAssetPath('/assets/character/yinyi-qishi.webp'),
...
const level9Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '炫蓝雷霆王',
    speakerImage: getAssetPath('/assets/character/xuanlan-leitingwang.webp'),
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '重装赤魂王',
    speakerImage: getAssetPath('/assets/character/zhongzhuang-chihunwang.webp'),
...
export const levels: Level[] = [
  // === 第一单元：图形与几何 ===
  {
    ...
    thumbnail: getAssetPath('/assets/character/juli-fengbao.webp'),
    status: 'available',
    guardian: getCharacterById('juli-fengbao') || characters[0],
    mentor: {
      id: 'xuanlan-shandian',
      name: '炫蓝闪电',
      image: getAssetPath('/assets/character/xuanlan-shandian.webp'),
      greeting: '欢迎来到炫卡世界！',
  ...
  },
  {
    ...
    thumbnail: getAssetPath('/assets/character/jiushi-weishi.webp'),
    status: 'locked',
  ...
  },
  {
    ...
    thumbnail: getAssetPath('/assets/character/liehuo-xiuluo.webp'),
    status: 'locked',
  ...
  // === 第二单元：20 以内退位减法 ===
  {
    ...
    thumbnail: getAssetPath('/assets/character/anying-tegong.webp'),
    status: 'locked',
  ...
  },
  {
    ...
    thumbnail: getAssetPath('/assets/character/tiebi-jueshi.webp'),
    status: 'locked',
  ...
  },
  {
    ...
    thumbnail: getAssetPath('/assets/character/penshi-jialun.webp'),
    status: 'locked',
  ...
  },
  {
    ...
    thumbnail: getAssetPath('/assets/character/liebian-qishi.webp'),
    status: 'locked',
  ...
  // === 第三单元：100 以内数的认识 ===
  {
    ...
    thumbnail: getAssetPath('/assets/character/baolie-zhongka.webp'),
    status: 'locked',
  ...
  },
  {
    ...
    thumbnail: getAssetPath('/assets/character/shenhai-tianmao.webp'),
    status: 'locked',
  ...
  },
  {
    ...
    thumbnail: getAssetPath('/assets/character/zhongli-jingang.webp'),
    status: 'locked',
  ...
  },
  {
    ...
    thumbnail: getAssetPath('/assets/character/xuantie-zhanshen.webp'),
    status: 'locked',
  ...
  // === 第四单元：100 以内口算加减法 ===
  {
    ...
    thumbnail: getAssetPath('/assets/character/xuanlan-shandian.webp'),
    status: 'locked',
  ...
  },
  {
    ...
    thumbnail: getAssetPath('/assets/character/yanlong-zhanshen-1.webp'),
    status: 'locked',
  ...
  },
  {
    ...
    thumbnail: getAssetPath('/assets/character/pili-huoying.webp'),
    status: 'locked',
  ...
  // === 第五单元：100 以内笔算加减法 ===
  {
    ...
    thumbnail: getAssetPath('/assets/character/liekong-hanjiang.webp'),
    status: 'locked',
  ...
  },
  {
    ...
    thumbnail: getAssetPath('/assets/character/gangbi-lishi.webp'),
    status: 'locked',
  ...
  // === 第六单元：BOSS 关 ===
  {
    ...
    thumbnail: getAssetPath('/assets/character/xingji-youxia-1.webp'),
    status: 'locked',
  ...
  // === 第七单元：欢乐购物街 ===
  {
    ...
    thumbnail: getAssetPath('/assets/character/baoxuan-luoke.webp'),
    status: 'locked',
  ...
  },
  {
    ...
    thumbnail: getAssetPath('/assets/character/shenhai-bawang.webp'),
    status: 'locked',
  ...
  // === 第八单元：找规律 ===
  {
    ...
    thumbnail: getAssetPath('/assets/character/yinyi-qishi.webp'),
    status: 'locked',
  ...
  // === 第九单元：期末综合 ===
  {
    ...
    thumbnail: getAssetPath('/assets/character/zhongzhuang-chihunwang.webp'),
    status: 'locked',
