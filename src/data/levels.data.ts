...
const level1_1Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '巨力风暴',
    speakerImage: '/assets/character/巨力风暴.png',
...
const level1_2Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '急救卫士',
    speakerImage: '/assets/character/急救卫士.png',
...
const level2_1Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '暗影特工',
    speakerImage: '/assets/character/暗影特工.png',
...
const level2_2Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '铁臂爵士',
    speakerImage: '/assets/character/铁臂爵士.png',
...
const level2_3Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '喷射加仑',
    speakerImage: '/assets/character/喷射加仑.png',
...
const level2_4Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '裂变骑士',
    speakerImage: '/assets/character/裂变骑士.png',
...
const level3_1Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '暴烈重卡',
    speakerImage: '/assets/character/暴烈重卡.png',
...
const level3_2Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '深海天锚',
    speakerImage: '/assets/character/深海天锚.png',
...
const level3_3Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '重力金刚',
    speakerImage: '/assets/character/重力金刚.png',
...
const level4_2Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '焰龙战神',
    speakerImage: '/assets/character/焰龙战神.png',
...
const level4_3Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '霹雳火影',
    speakerImage: '/assets/character/霹雳火影.png',
...
const level5_1Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '猎空悍将',
    speakerImage: '/assets/character/猎空悍将.png',
...
const level5_2Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '钢臂力士',
    speakerImage: '/assets/character/钢臂力士.png',
...
const level6Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '星际游侠',
    speakerImage: '/assets/character/星际游侠 1.png',
...
const level7_1Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '爆旋洛克',
    speakerImage: '/assets/character/爆旋洛克.png',
...
const level7_2Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '深海霸王',
    speakerImage: '/assets/character/深海霸王.png',
...
const level8Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '银翼骑士',
    speakerImage: '/assets/character/银翼骑士.png',
...
const level9Story: StorySegment[] = [
  ...
  },
  {
    ...
    speaker: '炫蓝闪电',
    speakerImage: '/assets/character/炫蓝闪电 1.png',
    text: '小勇士！重装赤魂王在期末综合考验等你！这一关包含了本学期所有的知识点！',
    duration: 4000,
  },
  {
    id: '3',
    type: 'dialogue',
    speaker: '重装赤魂王',
    speakerImage: '/assets/character/重装赤魂王.png',
    text: '轰！我是重装赤魂王！图形、加减、人民币、规律……用你学到的一切知识，通过终极考验！',
    duration: 4000,
  },
  {
    id: '4',
    type: 'narration',
    text: '小勇士，全力以赴，通过期末综合挑战！',
    duration: 2500,
  },
];
...
export const levels: Level[] = [
  // === 第一单元：图形与几何 ===
  {
    ...
    thumbnail: '/assets/character/巨力风暴.png',
    status: 'available',
  ...
  },
  {
    ...
    thumbnail: '/assets/character/急救卫士.png',
    status: 'locked',
  ...
  },
  {
    ...
    thumbnail: '/assets/character/烈火修罗.png',
    status: 'locked',
  ...
  // === 第二单元：20 以内退位减法 ===
  {
    ...
    thumbnail: '/assets/character/暗影特工.png',
    status: 'locked',
  ...
  },
  {
    ...
    thumbnail: '/assets/character/铁臂爵士.png',
    status: 'locked',
  ...
  },
  {
    ...
    thumbnail: '/assets/character/喷射加仑.png',
    status: 'locked',
  ...
  },
  {
    ...
    thumbnail: '/assets/character/裂变骑士.png',
    status: 'locked',
  ...
  // === 第三单元：100 以内数的认识 ===
  {
    ...
    thumbnail: '/assets/character/暴烈重卡.png',
    status: 'locked',
  ...
  },
  {
    ...
    thumbnail: '/assets/character/深海天锚.png',
    status: 'locked',
  ...
  },
  {
    ...
    thumbnail: '/assets/character/重力金刚.png',
    status: 'locked',
  ...
  // === 第四单元：100 以内口算加减法 ===
  {
    ...
    thumbnail: '/assets/character/炫蓝闪电 1.png',
    status: 'locked',
  ...
  },
  {
    ...
    thumbnail: '/assets/character/焰龙战神 1.png',
    status: 'locked',
  ...
  },
  {
    ...
    thumbnail: '/assets/character/霹雳火影.png',
    status: 'locked',
  ...
  // === 第五单元：100 以内笔算加减法 ===
  {
    ...
    thumbnail: '/assets/character/猎空悍将.png',
    status: 'locked',
  ...
  },
  {
    ...
    thumbnail: '/assets/character/钢臂力士.png',
    status: 'locked',
  ...
  // === 第六单元：BOSS 关 ===
  {
    ...
    thumbnail: '/assets/character/星际游侠 1.png',
    status: 'locked',
  ...
  // === 第七单元：欢乐购物街 ===
  {
    ...
    thumbnail: '/assets/character/爆旋洛克.png',
    status: 'locked',
  ...
  },
  {
    ...
    thumbnail: '/assets/character/深海霸王.png',
    status: 'locked',
  ...
  // === 第八单元：找规律 ===
  {
    ...
    thumbnail: '/assets/character/银翼骑士.png',
    status: 'locked',
