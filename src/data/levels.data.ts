...
const level1_1Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '炫蓝闪电',
    speakerImage: getAssetPath(getAssetPath('/assets/character/炫蓝闪电 1.png')),
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '巨力风暴',
    speakerImage: getAssetPath(getAssetPath('/assets/character/巨力风暴.png')),
...
const level1_2Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '急救卫士',
    speakerImage: getAssetPath(getAssetPath('/assets/character/急救卫士.png')),
...
const level2_1Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '暗影特工',
    speakerImage: getAssetPath(getAssetPath('/assets/character/暗影特工.png')),
...
const level2_2Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '铁臂爵士',
    speakerImage: getAssetPath(getAssetPath('/assets/character/铁臂爵士.png')),
...
const level2_3Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '喷射加仑',
    speakerImage: getAssetPath(getAssetPath('/assets/character/喷射加仑.png')),
...
const level2_4Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '裂变骑士',
    speakerImage: getAssetPath(getAssetPath('/assets/character/裂变骑士.png')),
...
const level3_1Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '暴烈重卡',
    speakerImage: getAssetPath(getAssetPath('/assets/character/暴烈重卡.png')),
...
const level3_2Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '深海天锚',
    speakerImage: getAssetPath(getAssetPath('/assets/character/深海天锚.png')),
...
const level3_3Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '重力金刚',
    speakerImage: getAssetPath(getAssetPath('/assets/character/重力金刚.png')),
...
const level3_4Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '玄铁战神',
    speakerImage: getAssetPath(getAssetPath('/assets/character/玄铁战神.png')),
...
const level4_2Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '焰龙战神',
    speakerImage: getAssetPath(getAssetPath('/assets/character/焰龙战神.png')),
...
const level4_3Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '霹雳火影',
    speakerImage: getAssetPath(getAssetPath('/assets/character/霹雳火影.png')),
...
const level5_1Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '猎空悍将',
    speakerImage: getAssetPath(getAssetPath('/assets/character/猎空悍将.png')),
...
const level5_2Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '钢臂力士',
    speakerImage: getAssetPath(getAssetPath('/assets/character/钢臂力士.png')),
...
const level6Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '星际游侠',
    speakerImage: getAssetPath(getAssetPath('/assets/character/星际游侠 1.png')),
...
const level7_1Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '爆旋洛克',
    speakerImage: getAssetPath(getAssetPath('/assets/character/爆旋洛克.png')),
...
const level7_2Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '深海霸王',
    speakerImage: getAssetPath(getAssetPath('/assets/character/深海霸王.png')),
...
const level8Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '银翼骑士',
    speakerImage: getAssetPath(getAssetPath('/assets/character/银翼骑士.png')),
...
const level9Story: StorySegment[] = [
  ...
  },
  {
    ...
    type: 'dialogue',
    speaker: '重装赤魂王',
    speakerImage: getAssetPath(getAssetPath('/assets/character/重装赤魂王.png')),
...
export const levels: Level[] = [
  // === 第一单元：图形与几何 ===
  {
    ...
    thumbnail: getAssetPath(getAssetPath('/assets/character/巨力风暴.png')),
    status: 'available',
  ...
  },
  {
    ...
    thumbnail: getAssetPath(getAssetPath('/assets/character/急救卫士.png')),
    status: 'locked',
  ...
  },
  {
    ...
    thumbnail: getAssetPath(getAssetPath('/assets/character/烈火修罗.png')),
    status: 'locked',
  ...
  // === 第二单元：20 以内退位减法 ===
  {
    ...
    thumbnail: getAssetPath(getAssetPath('/assets/character/暗影特工.png')),
    status: 'locked',
  ...
  },
  {
    ...
    thumbnail: getAssetPath(getAssetPath('/assets/character/铁臂爵士.png')),
    status: 'locked',
  ...
  },
  {
    ...
    thumbnail: getAssetPath(getAssetPath('/assets/character/喷射加仑.png')),
    status: 'locked',
  ...
  },
  {
    ...
    thumbnail: getAssetPath(getAssetPath('/assets/character/裂变骑士.png')),
    status: 'locked',
  ...
  // === 第三单元：100 以内数的认识 ===
  {
    ...
    thumbnail: getAssetPath(getAssetPath('/assets/character/暴烈重卡.png')),
    status: 'locked',
  ...
  },
  {
    ...
    thumbnail: getAssetPath(getAssetPath('/assets/character/深海天锚.png')),
    status: 'locked',
  ...
  },
  {
    ...
    thumbnail: getAssetPath(getAssetPath('/assets/character/重力金刚.png')),
    status: 'locked',
  ...
  },
  {
    ...
    thumbnail: getAssetPath(getAssetPath('/assets/character/玄铁战神.png')),
    status: 'locked',
  ...
  // === 第四单元：100 以内口算加减法 ===
  {
    ...
    thumbnail: getAssetPath(getAssetPath('/assets/character/炫蓝闪电 1.png')),
    status: 'locked',
  ...
  },
  {
    ...
    thumbnail: getAssetPath(getAssetPath('/assets/character/焰龙战神 1.png')),
    status: 'locked',
  ...
  },
  {
    ...
    thumbnail: getAssetPath(getAssetPath('/assets/character/霹雳火影.png')),
    status: 'locked',
  ...
  // === 第五单元：100 以内笔算加减法 ===
  {
    ...
    thumbnail: getAssetPath(getAssetPath('/assets/character/猎空悍将.png')),
    status: 'locked',
  ...
  },
  {
    ...
    thumbnail: getAssetPath(getAssetPath('/assets/character/钢臂力士.png')),
    status: 'locked',
  ...
  // === 第六单元：BOSS 关 ===
  {
    ...
    thumbnail: getAssetPath(getAssetPath('/assets/character/星际游侠 1.png')),
    status: 'locked',
  ...
  // === 第七单元：欢乐购物街 ===
  {
    ...
    thumbnail: getAssetPath(getAssetPath('/assets/character/爆旋洛克.png')),
    status: 'locked',
  ...
  },
  {
    ...
    thumbnail: getAssetPath(getAssetPath('/assets/character/深海霸王.png')),
    status: 'locked',
  ...
  // === 第八单元：找规律 ===
  {
    ...
    thumbnail: getAssetPath(getAssetPath('/assets/character/银翼骑士.png')),
    status: 'locked',
  ...
  // === 第九单元：期末综合 ===
  {
    ...
    thumbnail: getAssetPath(getAssetPath('/assets/character/重装赤魂王.png')),
    status: 'locked',
